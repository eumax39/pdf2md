...
DIRETORIO_SCRIPT = pathlib.Path(__file__).parent.resolve()
...
class App(ctk.CTk, TkinterDnD.DnDWrapper):
    def __init__(self):
        ...
        try: self.iconbitmap(str(DIRETORIO_SCRIPT / "icone.ico"))
        except: pass
    ...
    def criar_barra_lateral(self):
        ...
        try:
            caminho_logo = DIRETORIO_SCRIPT / "logo.png"
    ...
    def iniciar_conversao(self):
        ...
        # OCR passa a ser ativo por padrão para documentos escaneados;
        # o modo "Híbrido" continua priorizando texto nativo quando houver.
        usar_ocr = True
